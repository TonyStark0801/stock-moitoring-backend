package com.shubham.stockmonitoring.commons.constant;
...
public class ApiConstants {
    ...
    public static final String STOCKS_PATH = "/api/stocks";
    public static final String EXCHANGES_PATH = "/api/exchanges";
    public static final String SECTORS_PATH = "/api/sectors";
