...
public class EmailService {
    ...
    public void sendOtpVerificationEmail(String toEmail, String otp) {
        try {
            ...
            // Set friendly sender
            helper.setFrom(new InternetAddress(fromEmail, "Stock Monitoring"));

            // Set recipient
            helper.setTo(toEmail);

            // Subject with OTP
            helper.setSubject("🔐 Your OTP for Stock Monitoring - " + otp);
    ...
    private String createOtpEmailTemplate(String otp) {
        return """
            ...
            <body>
                <div class="container">
                    <div class="header">
                        <div class="logo">📈 Stock Monitoring</div>
                        <div class="subtitle">Your Personal Investment Dashboard</div>
                    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="message">
                            Thank you for registering with Stock Monitoring! To complete your account setup, please use the OTP below to verify your email address.
                        </div>
                    ...
                    <div class="footer">
                        <p>© 2024 Stock Monitoring. All rights reserved.</p>
